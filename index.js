...
function logic(){
  ...
  document.getElementById('name1').innerHTML=' Sakshi score  '+score1;
  document.getElementById('name2').innerHTML=' Abhi score  '+score2;

  if(score1>50){
    document.getElementById('name1').innerHTML='Sakshi Win';
    document.getElementById('name2').innerHTML='';

  }
  if(score2>50){
    document.getElementById('name1').innerHTML='';
    document.getElementById('name2').innerHTML='Abhi Win';
  }
}

function changeImage(img, number) {
  var bMusic = new Audio('sound/mixkit-feeling-happy-5.mp3')
	bMusic.play();
